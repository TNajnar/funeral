...
public class ServiceConfiguration {
    ...
    @Bean
    public StatisticsService statisticsService(@Nonnull ProductService productService, @Nonnull DbMapper dbMapper, @Nonnull ProductCategoryService productCategoryService) {
        return new StatisticsService(productService, productCategoryService, dbMapper);
    }
