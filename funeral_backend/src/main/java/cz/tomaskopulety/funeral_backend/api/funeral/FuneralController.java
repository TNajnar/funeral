                ...
                new FuneralGetResponses(
                        List.of(
                                FuneralGetResponse.builder()
                                        .timeCeremony(now.plusDays(5).withHour(9).withMinute(0).withSecond(0))
                                        ...
                                        .build(),
                                FuneralGetResponse.builder()
                                        .timeCeremony(now.plusDays(20).withHour(11).withMinute(30).withSecond(0))
                                        .placeCeremony("Krematorium Praha")
                                        .orderId(2025002)
                                        .companyId(1)
                                        .deceased("Thomas Angello")
                                        .created(now.plusHours(3).plusMinutes(25))
                                        .build(),
                                FuneralGetResponse.builder()
                                        .timeCeremony(now.plusDays(7).withHour(14).withMinute(0).withSecond(0))
                                        .placeCeremony("Hřbitov Olšany")
                                        .orderId(2025003)
                                        .companyId(1)
                                        .deceased("Miroslav Hrobek")
                                        .created(now.plusDays(3).plusHours(1).plusMinutes(10))
                                        .build()
                        )
                )
        );
